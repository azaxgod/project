...
import 'package:akimat_project/modules/dashboard/src/controller/users/kgu_users_controller.dart';
...
class KguUsersPage extends ConsumerWidget {
  const KguUsersPage({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final state = ref.watch(kguUsersControllerProvider);
    final controller = ref.read(kguUsersControllerProvider.notifier);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Управление пользователями КГУ ЖКХ',
