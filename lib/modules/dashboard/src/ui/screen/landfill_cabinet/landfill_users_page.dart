...
import 'package:akimat_project/modules/dashboard/src/controller/users/landfill_users_controller.dart';
...
class LandfillUsersPage extends ConsumerWidget {
  const LandfillUsersPage({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final state = ref.watch(landfillUsersControllerProvider);
    final controller = ref.read(landfillUsersControllerProvider.notifier);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Управление пользователями организации приёма снега',
